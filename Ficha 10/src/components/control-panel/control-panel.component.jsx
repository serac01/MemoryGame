        ...
        <section id="panel-control"> 
            ...
            <form className="form"> 
                <fieldset className="form-group left"> 
                    ...
                    <select id="btLevel" defaultValue="0" onChange={onLevelChange} disabled={gameStarted}> 
                ...
                <button type="button" id="btPlay" disabled={selectedLevel === "0"} onClick={onGameStart}>{gameStarted ? "Parar jogo" : "Iniciar Jogo"}</button> 
            </form>
            <div className="form-metadata">
                <p id="message" role="alert" className="hide">Clique em Iniciar o Jogo!</p>
